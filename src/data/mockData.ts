...
export const mockDashboardData = {
  ...
  recentDeployments: [
    { service: "user-service", version: "v1.2.3", status: "success", time: "2 min ago" },
    { service: "api-gateway", version: "v2.1.0", status: "success", time: "15 min ago" },
    { service: "notification-service", version: "v1.0.8", status: "pending", time: "22 min ago" },
    { service: "auth-service", version: "v3.4.1", status: "error", time: "1 hour ago" },
  ],
